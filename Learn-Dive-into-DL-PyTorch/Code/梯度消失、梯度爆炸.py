...
test_data = pd.read_csv(
    r"C:\Users\14274\Desktop\OpenSource\Learn-ML-in_Python\Learn-Dive-into-DL-PyTorch\dataset\houseprices/test.csv")
train_data = pd.read_csv(
    r"C:\Users\14274\Desktop\OpenSource\Learn-ML-in_Python\Learn-Dive-into-DL-PyTorch\dataset\houseprices/train.csv")

print("训练集数据质量:", train_data.head())
print("测试机数据质量:", test_data.head())
# 合并数据进行数据预处理
